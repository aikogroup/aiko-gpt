"""
Test du workflow avec validation humaine mock
"""
...
from human_in_the_loop.mock_human_validation_interface import MockHumanValidationInterface


def test_human_validation_workflow_mock():
    """
    Test du workflow avec validation humaine mock
    """
    print("🚀 Test du Workflow avec Validation Humaine Mock")
    print("=" * 60)
    ...
    try:
        ...
        # Remplacer l'interface humaine par l'interface mock
        print("🤖 Remplacement de l'interface humaine par l'interface mock...")
        mock_interface = MockHumanValidationInterface()
        
        # Définir des réponses mock personnalisées
        mock_responses = [
            "1,2,3,4,5",  # Première validation
            "6,7,8,9,10", # Deuxième validation si nécessaire
        ]
        mock_interface.set_mock_responses(mock_responses)
        
        # Remplacer l'interface dans le workflow
        workflow.human_interface = mock_interface
        ...
        print("   ├── Human Validation (validation mock)")
...
if __name__ == "__main__":
    success = test_human_validation_workflow_mock()
    
    if success:
        print("\n🎉 Workflow avec validation humaine mock fonctionnel!")
    else:
        print("\n💥 Workflow en erreur!")
