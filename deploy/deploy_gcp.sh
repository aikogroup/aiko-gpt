...
[ -n "${DATABASE_URL:-}" ] && API_ENV_VARS="${API_ENV_VARS}DATABASE_URL=${DATABASE_URL}"  # ← AJOUTER CETTE LIGNE
...
[ -n "${DATABASE_URL:-}" ] && STREAMLIT_ENV_VARS="${STREAMLIT_ENV_VARS},DATABASE_URL=${DATABASE_URL}"  # ← AJOUTER CETTE LIGNE
